...
car_details_path = "D:\VYOM\College\SEM 5\DC\data consistency\server\carDetails1.json"
host = "localhost"
user = "root"
passwd = "vyom@1234"
database = "db1"
...
if __name__ == '__main__':
    ...
    s_s = SimpleXMLRPCServer(("localhost", 8091))
    ...
    print("Trying to to store status for 1st time")
    ea.proc_store("slave")
